            ...
            foreach(string cn in candidateNames)
            {
                ...
                for (int i = 1; i<=4; i++)
                {
                    switch (i)
                    {
                        ...
                        case 2:
                            {
                                select = "SELECT Count(*) as \"COUNT\" FROM Ballots WHERE Candidate2 = '" + cn + "';";
                                selectCommand = new SqlCommand(select, con);
                                con.Open();
                                reader = selectCommand.ExecuteReader();
                                reader.Read();
                                c.Second = Convert.ToInt32(reader["COUNT"]);
                                con.Close();
                                break;
                            }
                        case 3:
                            {
                                select = "SELECT Count(*) as \"COUNT\" FROM Ballots WHERE Candidate3 = '" + cn + "';";
                                selectCommand = new SqlCommand(select, con);
                                con.Open();
                                reader = selectCommand.ExecuteReader();
                                reader.Read();
                                c.Third = Convert.ToInt32(reader["COUNT"]);
                                con.Close();
                                break;
                            }
                        case 4:
                            {
                                select = "SELECT Count(*) as \"COUNT\" FROM Ballots WHERE Candidate4 = '" + cn + "';";
                                selectCommand = new SqlCommand(select, con);
                                con.Open();
                                reader = selectCommand.ExecuteReader();
                                reader.Read();
                                c.Fourth = Convert.ToInt32(reader["COUNT"]);
                                con.Close();
                                break;
                            }
                        default:
